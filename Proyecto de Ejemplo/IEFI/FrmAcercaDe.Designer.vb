...
Partial Class FrmAcercaDe
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Este proyecto fue creado por Mogni Maria Carolina"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Analista de Sistemas de Computación"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "Laboratorio de Programación 1"
        '
        'FrmAcercaDe
        '
